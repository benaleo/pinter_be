...
import com.kasirpinter.pos.util.PaginationUtil;
...
public class GlobalConverter {
    ...
    public static <T extends AdminModelBaseDTOResponse, D extends AbstractEntity> void CmsIDTimeStampResponseAndId(
        ...
        dto.setCreatedAt(data.getCreatedAt() != null ? com.kasirpinter.pos.util.Formatter.formatLocalDateTime(data.getCreatedAt()) : null);
        dto.setUpdatedAt(data.getUpdatedAt() != null ? com.kasirpinter.pos.util.Formatter.formatLocalDateTime(data.getUpdatedAt()) : null);
    ...
    public static <T extends AdminModelBaseDTOResponse> void CmsIDTimeStampResponseAndIdProjection(
        ...
        dto.setId(dataId);
        dto.setCreatedAt(createdAt != null ? com.kasirpinter.pos.util.Formatter.formatLocalDateTime(createdAt) : null);
